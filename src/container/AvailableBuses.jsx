...
const AvailableBuses = ({ buses }) => {
  ...
  useEffect(() => {
    const areBusesAvailable = location?.state?.buses?.length > 0;
    setIsBusAvailable(areBusesAvailable);
  }, [location]);
  ...
  return (
    <div className="availableBuses">
      {isBusAvailable ? (
        ...
        <h2 className="top">
          Please check once , There is no Bus Available on this route or on this
          Date
        </h2>
      )}
      <div className="contentBuses">
